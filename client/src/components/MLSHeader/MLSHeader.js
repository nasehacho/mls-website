...
const subjects = [
  { name: 'Immunohematology (Blood Bank)', description: 'The study of antigen-antibody reactions associated with blood transfusions', href: '/subject/immunohematology', icon: ChartPieIcon },
  { name: 'Immunology', description: 'The study of the immune system', href: '/subject/immunology', icon: CursorArrowRaysIcon },
  { name: 'Microbiology', description: 'The study of the biology of microscopic organisms', href: '/subject/microbiology', icon: FingerPrintIcon },
